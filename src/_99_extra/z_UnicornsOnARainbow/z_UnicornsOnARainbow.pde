...
rainbow = loadImage("coolrainbow.jpg");
...
image (unicorn, mouseX-250,mouseY-100);
...
// 8.  MOVE.  Change the DRAW UNICORN code to use      mouseX, mouseY      in place of the numbers.
